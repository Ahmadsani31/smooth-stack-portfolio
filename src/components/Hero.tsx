  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center bg-deep-blue relative overflow-hidden pt-16 px-4">
      ...
      <div className="absolute inset-0 overflow-hidden opacity-10">
        ...
        <div className="absolute w-72 md:w-96 h-72 md:h-96 rounded-full bg-blue-600/30 bottom-10 right-10 blur-3xl"></div>
        <div className="absolute w-52 md:w-64 h-52 md:h-64 rounded-full bg-blue-400/30 bottom-40 left-1/4 blur-3xl"></div>
      </div>
      ...
      <div className="container mx-auto px-4 z-10">
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-8 md:gap-12">
          ...
          >
            <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight mb-4 mt-6 lg:mt-0 text-text-primary">
              <span className="block mb-2">Hello, I'm</span>
              <span className={`text-highlight block ${hasTypingAnimationRun ? 'typing-animation' : ''} ${isMobile ? 'mobile-typing' : ''}`}>
                Full Stack Web Developer
              </span>
            </h1>
            <p className="text-base md:text-lg text-text-secondary mt-6 mb-8 max-w-xl mx-auto lg:mx-0 animate-fade-in opacity-0" style={{ animationDelay: '1s', animationFillMode: 'forwards' }}>
          ...
          >
            <div className="relative w-52 h-52 sm:w-64 sm:h-64 md:w-72 md:h-72 lg:w-80 lg:h-80 xl:w-96 xl:h-96 bg-gradient-to-br from-highlight to-blue-600 rounded-full mx-auto flex items-center justify-center overflow-hidden">
              <div className="absolute inset-1 bg-deep-blue rounded-full flex items-center justify-center">
                <img 
                  src="https://placehold.co/600x600/F9FAFB/2563EB?text=Your+Photo"
        ...
        <motion.a 
          ...
          href="#about" 
          className="absolute bottom-8 md:bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce flex flex-col items-center text-text-secondary hover:text-highlight transition-colors duration-300"
        >
