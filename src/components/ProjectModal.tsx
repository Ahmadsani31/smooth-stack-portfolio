      ...
      <DialogContent className="max-w-4xl w-[90vw] max-h-[90vh] overflow-y-auto bg-white border border-gray-200 p-0">
        ...
        >
          ...
          <div className="sticky top-0 z-10 bg-white border-b border-gray-200 p-4 flex justify-between items-center">
            ...
            <DialogClose className="text-text-secondary hover:text-text-primary p-2">
              <X size={24} />
            </DialogClose>
          </div>
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-wrap gap-2">
                {project.technologies.map((tech) => (
                  <Badge 
                    key={tech}
                    className="bg-light-gray text-text-primary hover:bg-gray-200 transition-colors"
                  >
                    {tech}
                  </Badge>
                ))}
            ...
            <div className="flex flex-wrap gap-4 mt-6">
              ...
              {project.githubLink && (
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="bg-light-gray text-text-primary px-4 py-2 rounded-md transition-colors hover:bg-gray-300"
                >
                  View Source Code
                </a>
              )}
